  ...
  <header id="js-header" class="l-header p-header">
    <div class="l-header__inner">
      ...
      <div class="l-drawer">
        <div class="l-drawer__inner">
          <ul class="p-drawer__nav">
            <li class="p-drawer-nav__item"><a href="<?php echo esc_url(home_url('/')); ?>">ホーム</a></li>
            <li class="p-drawer-nav__item"><a href="<?php echo esc_url(home_url('/')); ?>about/">私について</a>
            </li class="p-drawer-nav__item">
            <li class="p-drawer-nav__item"><a href="<?php echo esc_url(home_url('/')); ?>works/">制作実績</a></li>
      ...
      <ul class="p-header__nav">
        <li class="p-header-nav_item"><a href="<?php echo esc_url(home_url('/')); ?>"
            <?php if(is_front_page())echo ' class="current"'; ?>>ホーム</a>
        </li>
        <li class="p-header-nav_item"><a href="<?php echo esc_url(home_url('/')); ?>about/"
            <?php if(is_page('about')) echo ' class="current"'; ?>>私について</a>
        </li>
        <li class="p-header-nav_item"><a href="<?php echo esc_url(home_url('/')); ?>works/"
